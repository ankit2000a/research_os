            ...
            try:
                ...
                if not papers_data:
                    ...
                    with tab1:
                        ...
                        Begin directly, without any introductory phrases.
                        Identify the core theme, explain each paper's contribution, and highlight the relationships between them.
                        """
                        response_text = model_text.generate_content([prompt_text, "Here is the text from the papers:", combined_abstracts])
